...
arrow (`/target_pose`) shows where your hand is commanding the EE.
...
(Verified: this makes the servo emit `/arm_controller/joint_trajectory` commands and the arm moves in RViz.)
