        ...
        self._spokes = {
            "yellow": [
                ...
                {"name": "yellow_back",     "kind": STEP_STRAIGHT,
                 "distance": -0.20, "speed": 0.10, "follow_line": True},
                {"name": "yellow_turn_back","kind": STEP_TURN,
                 "dtheta": math.radians(-90.0), "angular_speed": 0.2},
            ],
            "blue": [
                # blue sits slightly to the RIGHT of the hub (small lateral
                # offset, not a 90° rotation). Strafe -y first to align,
                # then drive straight forward. Heading stays pointed at the
                # panel throughout — no TURN steps.
